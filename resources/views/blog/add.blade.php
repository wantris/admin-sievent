...
<div class="row">
    <div class="col-lg-8 col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{route('blog.save')}}" enctype="multipart/form-data" method="post">
                    @csrf
                    <div class="form-group">
                        <label for="">Judul</label>
                        <input type="text" id="title-inp" value="{{ old('title') }}" name="title" class="form-control">
                        @if ($errors->has('title'))
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="konten" id="konten-inp"  class="form-control">{{ old('konten') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="image" onchange="loadPhoto(event)" value="{{ old('image') }}" id="image-inp" class="form-control">
                        @if ($errors->has('image'))
    ...
    <div class="col-lg-4 col-12">
        <div class="card">
            <div class="card-body">
                <img src="" class="img-fluid" id="photo-image" alt="">
            </div>
        </div>
    </div>
</div>
