            ...
            <form method="POST" action="{{route('auth.index.post')}}" class="needs-validation mt-4" novalidate="">
                ...
                <div class="form-group">
                    ...
                    <select name="role" id="" class="form-control">
                        ...
                        <option value="wadir3">Wadir 3</option>
                    </select>
                    {{-- <div class="d-block">
                        <a href="#" onclick="chooseRole('admin')" id="role_admin" class="btn-role btn btn-primary d-inline">Admin</a>
                        <a href="#" onclick="chooseRole('wadir3')" id="role_wadir3" class="btn-role btn btn-primary d-inline ml-3">Wadir 3</a>
                    </div> --}}
                    {{-- <input id="username" type="hidden" class="form-control" name="username" tabindex="1" required autofocus> --}}
                </div>
                <div class="form-group">
