                        ...
                        <form
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="validate_pembina" @if (Session::get('is_admin')=="0" ) disabled @endif
                                    ...
                                    <input type="hidden" name="validate_pembina"
                                        value="{{$pengajuan->is_validated_pembina}}">
                                    @endif
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="validate_wadir3" @if($pengajuan->is_validated_pembina == 0) disabled
                                        @endif id="" class="form-control">
                                        @if ($pengajuan->is_validated_wadir3 == 1)
                                ...
                                @if ($pengajuan->is_validated_pembina == 0)
                                <small class="text-muted">Harus divalidasi pembina terlebih dahulu</small>
                                @endif
                        ...
                        <form action="" enctype="multipart/form-data" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input disabled type="text" required
                                        value="{{$event->nama_event}}" name="nama"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select disabled class="form-control" name="kategori" id="">
                                        <option value="{{$event->kategori_ref->id_kategori}}"
                                            selected>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select disabled class="form-control" name="tipe_peserta" id="">
                                        <option value="{{$event->tipe_peserta_ref->id_tipe_peserta}}"
                                            selected>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input disabled type="text" required
                                        value="{{$event->maks_participant}}" name="maks"
                                        class="form-control phone-number">
                                </div>
                                @if ($errors->has('maks'))
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input disabled type="date" required
                                        value="{{$event->tgl_buka}}" name="tgl_buka"
                                        class="form-control phone-number">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input disabled type="date" required
                                        value="{{$event->tgl_tutup}}" name="tgl_tutup"
                                        class="form-control phone-number">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea disabled name="ketentuan"
                                    class="form-control">{{$event->ketentuan}}</textarea>
